...
import edu.tacoma.uw.udeal.MessageFormat;
import java.util.List;

import edu.tacoma.uw.udeal.Chat;
...
public class MessageAdapter extends ArrayAdapter<MessageFormat> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.i(Chat.TAG, "getView:");

        edu.tacoma.uw.udeal.MessageFormat message = getItem(position);
        ...
        if(TextUtils.isEmpty(message.getMessage())){
            ...
            Log.i(Chat.TAG, "getView: is empty ");
            String userConnected = message.getUsername();
            messageText.setText(userConnected);

        }else if(message.getUniqueId().equals(Chat.uniqueId)){
            Log.i(Chat.TAG, "getView: " + message.getUniqueId() + " " + Chat.uniqueId);
            ...
            Log.i(Chat.TAG, "getView: is not empty");
