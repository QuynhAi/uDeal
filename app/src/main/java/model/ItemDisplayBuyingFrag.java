...
public class ItemDisplayBuyingFrag implements Serializable {
    ...
    public void setMyLiked(boolean myLiked) {
        ...
        if(this.myLiked) {
            ...
            try {
                mArguments.put(ItemDisplayBuyingFrag.LIKED_ITEM_ID, myItemID);
                mArguments.put(ItemDisplayBuyingFrag.LIKER_ID, myLikerID);
                mArguments.put(ItemDisplayBuyingFrag.LIKED, this.myLiked);
    ...
    public static ItemDisplayBuyingFrag parseItemJson(JSONObject itemJSON, int myIndex, BuyingFrag.SimpleItemRecyclerViewAdapter myAdapter, int myID) throws JSONException {
        ...
        ItemDisplayBuyingFrag item = new ItemDisplayBuyingFrag(
                obj.getInt(ItemDisplayBuyingFrag.ITEM_ID),
                obj.getInt(ItemDisplayBuyingFrag.MEMBER_ID),
                obj.getString(ItemDisplayBuyingFrag.URL),
                obj.getString(ItemDisplayBuyingFrag.TITLE),
                obj.getString(ItemDisplayBuyingFrag.LOCATION),
                obj.getString(ItemDisplayBuyingFrag.DESCRIPTION),
                obj.getString(ItemDisplayBuyingFrag.CATEGORY),
                obj.getDouble(ItemDisplayBuyingFrag.PRICE),
                obj.getBoolean(ItemDisplayBuyingFrag.LISTED),
                obj.getString(ItemDisplayBuyingFrag.DATE_POSTED),
                myIndex,
                myAdapter,
                obj.getString(ItemDisplayBuyingFrag.USERNAME),
                obj.getBoolean(ItemDisplayBuyingFrag.LIKED),
                myID);
        return item;
    }
